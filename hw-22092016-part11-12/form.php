...
if(clean($_POST['city']) && clean($_POST['age'])) {
	$_SESSION['city'] = clean($_POST['city']);
	$_SESSION['age'] = clean($_POST['age']);
			...
			<div class="col-md-12">
				<form action="" method="POST">
				  ...
				  <div class="form-group">
				    ...
				    <input name="city" type="text" class="form-control" id="city" value="<?= $_SESSION['city']; ?>">
				  </div>
				  <div class="form-group">
				    <label for="age">Введите ваш возраст</label>
				    <input name="age" type="text" class="form-control" id="age" value="<?= $_SESSION['age']; ?>">
				  </div>
